    ...
    >
      ...
      >
        <img
          ...
          alt=""
          aria-hidden="true"
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[clamp(160px,40vh,480px)] h-[clamp(160px,40vh,480px)] max-w-none object-contain opacity-10 pointer-events-none drop-shadow-md z-0"
        />

        <span
          className="relative z-10 text-sm font-semibold uppercase tracking-widest opacity-70"
        ...
        <span
          className="relative font-black leading-none drop-shadow-2xl transition-colors duration-500 z-10 -mt-1"
          style={{
        ...
        <div
          className="relative z-10 w-full max-w-lg backdrop-blur-md border rounded-2xl px-5 py-3.5 text-center shadow-2xl transition-all duration-500 flex flex-col gap-1"
          style={{
        ...
        >
          ...
          {acceleration != null && (
            <span
              className="inline-block self-center px-3 py-1 rounded-full text-xs font-semibold tracking-wide"
              style={{
